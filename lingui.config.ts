...
import { APP_LOCALES, SOURCE_LOCALE } from './src/core/i18n/locales.constant.js'
...
export default defineConfig({
  ...
  catalogs: [
    { path: '<rootDir>/src/core/i18n/catalogs/{locale}', include: ['src'] }
  ],
  catalogsMergePath: '<rootDir>/src/core/i18n/generated/{locale}',
  compileNamespace: 'ts',
