...
export type StorageHash =
  StorageHashBase<'cdf3d02fbd3dc806b826d973e018c6bb328bb58e103263bfab4d81dae2456d39'>;
          ...
          readonly table: {
            readonly monitor: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'monitor_last_status_created_at_id_idx_e95a53d0';
                  readonly prefix: 'monitor_last_status_created_at_id_idx';
                  readonly columns: readonly ['last_status', 'created_at', 'id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'monitor_name_id_idx_69098186';
                  readonly prefix: 'monitor_name_id_idx';
            ...
            readonly monitorCheck: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'monitorCheck_status_checked_at_id_idx_7a19b2ee';
                  readonly prefix: 'monitorCheck_status_checked_at_id_idx';
                  readonly columns: readonly ['status', 'checked_at', 'id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'monitorCheck_error_type_checked_at_id_idx_09d592cb';
                  readonly prefix: 'monitorCheck_error_type_checked_at_id_idx';
                  readonly columns: readonly ['error_type', 'checked_at', 'id'];
                  readonly unique: false;
                },
                {
